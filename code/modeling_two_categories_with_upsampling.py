...
def up_sampler(df,minority_class, majority_class):
    ...
    temp_minority = df[df["Rating"] == minority_class]
...
y_train, y_valid, y_test = tf.convert_to_tensor(y_train.astype(int)), tf.convert_to_tensor(y_valid.astype(int)), tf.convert_to_tensor(y_test.astype(int))
